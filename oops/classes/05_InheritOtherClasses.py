...
class Vehicle:
    def __init__(self,name,color,mileage,price):
        self.name = name
        self.color = color
    ...
    def description(self):
        return f"{self.name} is of color {self.color}. It gives the mileage of {self.mileage}. Price of {self.name} is {self.price}"

class RangeRover(Vehicle):
    def __init__(self, name, color, mileage, price):
        super().__init__("ranger", color, mileage, price)

car1 = RangeRover("Rover","red","60","$20000")
